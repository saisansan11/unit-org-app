...
class SignalCorpsData {
  ...
  static const List<QuizQuestion> quizQuestions = [
    ...
    QuizQuestion(
      id: 'q_size_4',
      question: 'หมู่ (Squad) มีกำลังพลประมาณเท่าไร?',
      options: ['2-5 คน', '8-13 คน', '25-50 คน', '80-250 คน'],
      correctIndex: 1,
      explanation: 'หมู่ (Squad) มีกำลังพลประมาณ 8-13 คน นำโดยสิบเอก',
      category: 'ขนาดหน่วย',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_size_5',
      question: 'กองร้อย (Company) มีกำลังพลประมาณเท่าไร?',
      options: ['25-50 คน', '80-250 คน', '300-1,000 คน', '2,000-5,000 คน'],
      correctIndex: 1,
      explanation: 'กองร้อยมีกำลังพล 80-250 คน ประกอบด้วย 3-5 หมวด',
      category: 'ขนาดหน่วย',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_size_6',
      question: 'กรม (Regiment) มีกำลังพลประมาณเท่าไร?',
      options: ['300-1,000 คน', '2,000-5,000 คน', '10,000-20,000 คน', '20,000-45,000 คน'],
      correctIndex: 1,
      explanation: 'กรมมีกำลังพล 2,000-5,000 คน ประกอบด้วย 2-3 กองพัน',
      category: 'ขนาดหน่วย',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_size_7',
      question: 'กองพล (Division) มีกำลังพลประมาณเท่าไร?',
      options: ['2,000-5,000 คน', '10,000-20,000 คน', '20,000-45,000 คน', '45,000-80,000 คน'],
      correctIndex: 1,
      explanation: 'กองพลมีกำลังพล 10,000-20,000 คน ประกอบด้วย 3-5 กรม',
      category: 'ขนาดหน่วย',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_size_8',
      question: 'ชุด (Team) เป็นหน่วยระดับใด?',
      options: ['เล็กกว่าหมู่', 'เท่ากับหมู่', 'ใหญ่กว่าหมู่', 'เท่ากับหมวด'],
      correctIndex: 0,
      explanation: 'ชุด (Team) มีกำลังพล 2-5 คน เป็นหน่วยเล็กที่สุดเล็กกว่าหมู่',
      category: 'ขนาดหน่วย',
      difficulty: 1,
    ),
    ...
    QuizQuestion(
      id: 'q_symbol_4',
      question: 'สัญลักษณ์ I หมายถึงหน่วยระดับใด?',
      options: ['หมู่', 'หมวด', 'กองร้อย', 'กองพัน'],
      correctIndex: 2,
      explanation: 'สัญลักษณ์ I (ขีดเดียว) หมายถึง กองร้อย (Company)',
      category: 'สัญลักษณ์',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_symbol_5',
      question: 'สัญลักษณ์ III หมายถึงหน่วยระดับใด?',
      options: ['กองพัน', 'กรม', 'กองพลน้อย', 'กองพล'],
      correctIndex: 1,
      explanation: 'สัญลักษณ์ III (สามขีด) หมายถึง กรม (Regiment)',
      category: 'สัญลักษณ์',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_symbol_6',
      question: 'สัญลักษณ์ X หมายถึงหน่วยระดับใด?',
      options: ['กรม', 'กองพลน้อย', 'กองพล', 'กองทัพน้อย'],
      correctIndex: 1,
      explanation: 'สัญลักษณ์ X (กากบาทเดียว) หมายถึง กองพลน้อย (Brigade)',
      category: 'สัญลักษณ์',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_symbol_7',
      question: 'สัญลักษณ์ XXX หมายถึงหน่วยระดับใด?',
      options: ['กองพล', 'กองทัพน้อย', 'กองทัพภาค', 'กองทัพบก'],
      correctIndex: 1,
      explanation: 'สัญลักษณ์ XXX (สามกากบาท) หมายถึง กองทัพน้อย (Corps)',
      category: 'สัญลักษณ์',
      difficulty: 2,
    ),
    QuizQuestion(
      ...
      options: ['ชุด', 'หมู่', 'หมวด', 'กองร้อย'],
      correctIndex: 1,
      explanation: 'สัญลักษณ์ ● (จุดเดียว) หมายถึง หมู่ (Squad)',
      category: 'สัญลักษณ์',
      difficulty: 1,
    ),
    ...
    QuizQuestion(
      id: 'q_cmd_4',
      question: 'ผู้บังคับกองร้อยมียศอะไร?',
      options: ['ร้อยตรี', 'ร้อยโท', 'ร้อยเอก หรือ พันตรี', 'พันโท'],
      correctIndex: 2,
      explanation: 'ผู้บังคับกองร้อยมียศ ร้อยเอก (ร.อ.) หรือ พันตรี (พ.ต.)',
      category: 'ผู้บังคับบัญชา',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_cmd_5',
      question: 'ผู้บังคับหมวดมียศอะไร?',
      options: ['สิบเอก', 'ร้อยตรี หรือ ร้อยโท', 'ร้อยเอก', 'พันตรี'],
      correctIndex: 1,
      explanation: 'ผู้บังคับหมวดมียศ ร้อยตรี (ร.ต.) หรือ ร้อยโท (ร.ท.)',
      category: 'ผู้บังคับบัญชา',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_cmd_6',
      question: 'ผู้บังคับการกรมมียศอะไร?',
      options: ['พันโท', 'พันเอก', 'พลจัตวา', 'พลตรี'],
      correctIndex: 1,
      explanation: 'ผู้บังคับการกรมมียศ พันเอก (พ.อ.)',
      category: 'ผู้บังคับบัญชา',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_cmd_7',
      question: 'แม่ทัพภาคมียศอะไร?',
      options: ['พลตรี', 'พลโท', 'พลเอก', 'จอมพล'],
      correctIndex: 1,
      explanation: 'แม่ทัพภาคมียศ พลโท (พล.ท.)',
      category: 'ผู้บังคับบัญชา',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_cmd_8',
      question: 'ผู้บัญชาการทหารบกมียศอะไร?',
      options: ['พลโท', 'พลเอก', 'จอมพล', 'พลตรี'],
      correctIndex: 1,
      explanation: 'ผู้บัญชาการทหารบกมียศ พลเอก (พล.อ.)',
      category: 'ผู้บังคับบัญชา',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_cmd_9',
      question: 'รองผู้บังคับกองพันมียศอะไร?',
      options: ['พันตรี', 'พันโท', 'พันเอก', 'ร้อยเอก'],
      correctIndex: 0,
      explanation: 'รองผู้บังคับกองพันมียศ พันตรี (พ.ต.)',
      category: 'ผู้บังคับบัญชา',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_cmd_10',
      question: 'จ่ากองพัน (จ่า พัน.) มียศอะไร?',
      options: ['สิบเอก', 'จ่าสิบตรี', 'จ่าสิบเอก', 'พันจ่าเอก'],
      correctIndex: 2,
      explanation: 'จ่ากองพันมียศ จ่าสิบเอก (จ.ส.อ.) เป็นนายสิบอาวุโสประจำกองพัน',
      category: 'ผู้บังคับบัญชา',
      difficulty: 2,
    ),
    ...
    QuizQuestion(
      id: 'q_structure_4',
      question: '1 กรม ประกอบด้วยกี่กองพัน?',
      options: ['2-3 กองพัน', '4-5 กองพัน', '6-8 กองพัน', '10 กองพัน'],
      correctIndex: 0,
      explanation: '1 กรมประกอบด้วย 2-3 กองพัน รวมกำลังพล 2,000-5,000 คน',
      category: 'โครงสร้าง',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_structure_5',
      question: '1 กองพล ประกอบด้วยกี่กรม?',
      options: ['2 กรม', '3-5 กรม', '6-8 กรม', '10 กรม'],
      correctIndex: 1,
      explanation: '1 กองพลประกอบด้วย 3-5 กรม รวมกำลังพล 10,000-20,000 คน',
      category: 'โครงสร้าง',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_structure_6',
      question: 'โครงสร้างของหน่วยทหารเรียงจากเล็กไปใหญ่ข้อใดถูกต้อง?',
      options: [
        'หมู่ > หมวด > กองร้อย > กองพัน',
        'หมวด > หมู่ > กองร้อย > กองพัน',
        'กองร้อย > หมวด > หมู่ > กองพัน',
        'หมู่ > กองร้อย > หมวด > กองพัน'
      ],
      correctIndex: 0,
      explanation: 'ลำดับถูกต้องคือ: ชุด < หมู่ < หมวด < กองร้อย < กองพัน < กรม < กองพล',
      category: 'โครงสร้าง',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_structure_7',
      question: 'หน่วยรบพื้นฐานที่เล็กที่สุดในกองทัพบกคือหน่วยใด?',
      options: ['พลทหาร', 'ชุด', 'หมู่', 'หมวด'],
      correctIndex: 1,
      explanation: 'ชุด (Team) เป็นหน่วยรบพื้นฐานที่เล็กที่สุดมี 2-5 คน',
      category: 'โครงสร้าง',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_structure_8',
      question: 'กองทัพน้อย (Corps) ประกอบด้วยกี่กองพล?',
      options: ['1-2 กองพล', '2-5 กองพล', '6-10 กองพล', '10-15 กองพล'],
      correctIndex: 1,
      explanation: 'กองทัพน้อยประกอบด้วย 2-5 กองพล มีกำลังพล 20,000-45,000 คน',
      category: 'โครงสร้าง',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_structure_9',
      question: 'กองทัพภาคมีโครงสร้างอยู่ระหว่างหน่วยใด?',
      options: [
        'กองพล - กองทัพน้อย',
        'กองทัพน้อย - กองทัพบก',
        'กรม - กองพล',
      ...
      correctIndex: 1,
      explanation: 'กองทัพภาค (Regional Army) อยู่ระหว่างกองทัพน้อยและกองทัพบก มีกำลังพล 45,000-80,000 คน',
      category: 'โครงสร้าง',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_structure_10',
      question: 'กองพันทหารสื่อสารมีโครงสร้างหลักประกอบด้วยอะไรบ้าง?',
      options: [
        'บก., ร้อย.วิทยุ, ร้อย.สาย',
        'บก., ร้อย.ว.ศข., ร้อย.ส.วถ.',
        'บก., ร้อย.รบ, ร้อย.สนับสนุน',
        'บก., ร้อย.ยิง, ร้อย.สอดแนม'
      ],
      correctIndex: 1,
      explanation: 'กองพัน ส. มีโครงสร้าง: บก.และร้อย.บก., ร้อย.วิทยุและศูนย์ข่าว (ร้อย.ว.ศข.), ร้อย.สายและวิทยุถ่ายทอด (ร้อย.ส.วถ.)',
      category: 'โครงสร้าง',
      difficulty: 2,
    ),
    ...
    QuizQuestion(
      id: 'q_area_4',
      question: 'กองทัพภาคที่ 1 (ทภ.1) รับผิดชอบพื้นที่ใด?',
      options: [
      ...
      correctIndex: 0,
      explanation: 'ทภ.1 รับผิดชอบภาคกลางและภาคตะวันตก มีกองบัญชาการที่กรุงเทพฯ',
      category: 'กองทัพภาค',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_area_5',
      question: 'กองทัพภาคที่ 3 (ทภ.3) รับผิดชอบพื้นที่ใด?',
      options: [
        'ภาคกลาง',
        'ภาคตะวันออกเฉียงเหนือ',
        'ภาคเหนือ',
      ...
      correctIndex: 2,
      explanation: 'ทภ.3 รับผิดชอบภาคเหนือ มีกองบัญชาการที่ค่ายสมเด็จพระนเรศวรมหาราช จ.พิษณุโลก',
      category: 'กองทัพภาค',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_area_6',
      question: 'ค่ายสุรนารี ตั้งอยู่จังหวัดใด?',
      options: [
        'ขอนแก่น',
        'อุดรธานี',
        'นครราชสีมา',
      ...
      correctIndex: 2,
      explanation: 'ค่ายสุรนารี ตั้งอยู่ที่ จ.นครราชสีมา เป็นที่ตั้งของ ทภ.2',
      category: 'กองทัพภาค',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_area_7',
      question: 'กองทัพภาคใดรับผิดชอบพื้นที่ 3 จังหวัดชายแดนใต้?',
      options: ['ทภ.1', 'ทภ.2', 'ทภ.3', 'ทภ.4'],
      correctIndex: 3,
      explanation: 'ทภ.4 รับผิดชอบภาคใต้รวมถึง 3 จังหวัดชายแดนใต้ (ปัตตานี ยะลา นราธิวาส)',
      category: 'กองทัพภาค',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_area_8',
      question: 'กองทัพบกไทยมีกองทัพภาคทั้งหมดกี่กองทัพภาค?',
      options: ['3 กองทัพภาค', '4 กองทัพภาค', '5 กองทัพภาค', '6 กองทัพภาค'],
      correctIndex: 1,
      explanation: 'กองทัพบกไทยมี 4 กองทัพภาค: ทภ.1 (กลาง), ทภ.2 (อีสาน), ทภ.3 (เหนือ), ทภ.4 (ใต้)',
      category: 'กองทัพภาค',
      difficulty: 1,
    ),
    QuizQuestion(
      id: 'q_area_9',
      question: 'ค่ายกาวิละ ตั้งอยู่จังหวัดใด?',
      options: [
        'เชียงใหม่',
        'เชียงราย',
        'พิษณุโลก',
      ...
      correctIndex: 0,
      explanation: 'ค่ายกาวิละ ตั้งอยู่ที่ จ.เชียงใหม่ เป็นที่ตั้งของกองพลทหารราบที่ 7',
      category: 'กองทัพภาค',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_area_10',
      question: 'กองพลทหารราบที่ 2 รักษาพระองค์ (พล.ร.2 รอ.) ตั้งอยู่ที่จังหวัดใด?',
      options: [
        'กรุงเทพฯ',
        'ปราจีนบุรี',
        'สระบุรี',
      ...
      correctIndex: 1,
      explanation: 'พล.ร.2 รอ. มีที่ตั้งที่ค่ายพรหมโยธี จ.ปราจีนบุรี สังกัด ทภ.1',
      category: 'กองทัพภาค',
      difficulty: 2,
    ),
    QuizQuestion(
      id: 'q_area_11',
      question: 'กองพลทหารราบที่ 3 ตั้งอยู่ที่จังหวัดใด?',
      options: [
        'นครราชสีมา',
        'ขอนแก่น',
        'อุดรธานี',
      ...
      correctIndex: 0,
      explanation: 'พล.ร.3 ตั้งอยู่ที่ค่ายสุรนารี จ.นครราชสีมา สังกัด ทภ.2',
      category: 'กองทัพภาค',
      difficulty: 2,
    ),
